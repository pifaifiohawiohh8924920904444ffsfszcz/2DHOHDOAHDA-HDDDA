...
if isfile('newvape/games/'..vape.Place..'.lua') then
	...
	if not shared.VapeDeveloper then
		local suc, res = pcall(function() return 
			game:HttpGet('https://raw.githubusercontent.com/pifaifiohawiohh8924920904444ffsfszcz/2DHOHDOAHDA-HDDDA/'..readfile('newvape/profiles/commit.txt')..'/games/'..vape.Place..'.lua', true) 
		end)
